...
class ReservaTest {
	...
	public void testCheckInData() {
		...
		// Assert:
		assertEquals(LocalDate.of(2024, 9, 1), reserva.getCheckInData(), "A data de check-in deve ser igual ao valor atribuido");
	}
	...
	public void testCheckinoutData() {
		...
		// Assert: 
		assertEquals(LocalDate.of(2024, 9, 10), reserva.getCheckOutData(), "A data de check-out deve ser igual ao valor atribuido");
	}
